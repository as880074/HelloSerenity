    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your HelloSerenity Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your HelloSerenity Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "HelloSerenity";
        }
